...
def make_plots(all_logdirs, legend=None,
    ...
    for value in values:
        ...
        try:
            ...
            pass
        fig.savefig(all_logdirs[0] + 'Fig_3obj' + select_str + exclude_str + '.png',
                    bbox_inches='tight',
                    dpi=600)
        fig.savefig(all_logdirs[0] + 'Fig_3obj' + select_str + exclude_str + '.svg',
                    bbox_inches='tight',
                    dpi=600)
    ...
    if len(sys.argv) > 1:
        ...
        parser.add_argument('--logdir', '-r', type=list,
                            default=[
                                ...
                                "/home/robot/robot_code/rher_multi_obj/tune_rher_last/RHER_TD3_3obj_opt70_last_seeds/2",
                                "/home/robot/robot_code/rher_multi_obj/tune_her/HER_3obj_un40/2",
                                # Ubuntu路径示例：
