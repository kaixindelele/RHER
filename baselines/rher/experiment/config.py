...
from baselines.rher.ddpg import DDPG
from baselines.rher.her_sampler import make_sample_her_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'baselines.rher.actor_critic:ActorCritic',
