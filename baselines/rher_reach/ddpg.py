...
from baselines.rher_reach.util import (
    import_function, store_args, flatten_grads, transitions_in_episode_batch, convert_episode_to_batch_major)
from baselines.rher_reach.normalizer import Normalizer
from baselines.rher_reach.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        Args:
            ...
            network_class (str): the network class that should be used (e.g. 'baselines.rher_reach.ActorCritic')
    ...
    def check_reached(self, gg, ag, g, reward_func=None, th=0.14):
        ...
        if th < 0.05:
            ...
            if grip2obj > th and reward_func(gg, ag, None) == -1:
                ...
                reached = True
        # if grip2obj > th and reward_func(ag, g, None) == -1:
        #     reached = False
        # else:
        #     reached = True
        return reached
    ...
    def get_actions(self, o, ag, g, noise_eps=0., random_eps=0., use_target_net=False,
                    compute_Q=False, rew_func=None, epoch=0):
        rd = 0.2
        rr = 0.4 / (1.0 - rd)
        anneal = False
        th = 0.03
    ...
    def _create_network(self, reuse=False):
        ...
        if self.bc_loss ==1 and self.q_filter == 1 : # train with demonstrations and use bc_loss and q_filter both
            ...
            #define the cloning loss on the actor's actions only on the samples which adher_reache to the above masks
