...
from baselines.rher_reach.ddpg import DDPG
from baselines.rher_reach.her_sampler import make_sample_her_transitions
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'baselines.rher_reach.actor_critic:ActorCritic',
...
def configure_her(params):
    ...
    def reward_fun(ag_2, g, info):  # vectorized
        return env.compute_reward(ag_2, g, info)
